...
def key_findings(persistence, exceedance):
    ...
    add("criterion is recorded met on the interval evidence**; its tail clause -- tail")
    add("exceedance probabilities, and climatology on a knowledge holdout -- is not scored.")
    add("")
